from PyQt5.QtWidgets import QMainWindow, QFileDialog, QLabel, QPushButton, QProgressBar, QCheckBox, QComboBox
...
class ImageRestyler(QMainWindow):
    ...
    def initUI(self):
        ...
        self.original_image_mask.setText("Original Image Mask")
        ...
        self.prog_bar.setGeometry(600, 850, 300, 25)
        self.prog_bar.setValue(0)
        self.prog_bar.setFormat('Restyling progress')
        self.prog_bar.setStyleSheet("background-color:#eaf2c9")
        ...
        for k in range (2, 26):
            self.cb_train_iter_no.addItem(str(k * 5))
    ...
    def train_iter_no_changed(self, i):
        print(int(self.cb_train_iter_no.itemText(i)))
    ...
    def style_transfer(self):
        ...
        result_image = self.restyler.restyle()
